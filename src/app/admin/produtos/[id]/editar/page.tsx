    ...
    const loadProduct = async () => {
      try {
        ...
        setForm({
          ...
          weight_grams: (productData as any).weight_grams,
          length_cm: (productData as any).length_cm,
          width_cm: (productData as any).width_cm,
          height_cm: (productData as any).height_cm
        })
      } catch (error) {
